import { InputGroup } from "./index2_input_group.js";
...
class Register {
    ...
    handleSubmit(evt){
        ...
        if(password.length<6){
            this.$inputGroupPassword.setError('Password cannot less than 6')
        }
        if(confirmPassword != password){
            this.$inputGroupConfirmPassword.setError('Confirm Password is different')
        }
